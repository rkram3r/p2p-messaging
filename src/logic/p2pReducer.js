export default (
  ...
  if (type === "VERIFIED") {
    ...
    return {
      ...oldState,
      recievedMessages: oldState.recievedMessages.map(x => {
  ...
  if (type === "CONTACTLIST") {
    ...
    return {
      ...oldState,
      contactlist: new Map([...contactlist, ...oldState.contactlist])
    };
  }
